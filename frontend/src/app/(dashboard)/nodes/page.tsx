        ...
        <div className="space-y-4 font-mono max-w-full overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 border-b border-tactical-border/60 pb-3">
                <div>
                    ...
                    <h1 className="text-sm sm:text-base font-extrabold text-white tracking-tight">Distributed Forensic Node Registry</h1>
                    <p className="text-[9px] sm:text-[10px] text-zinc-400 mt-0.5">Polygon zkEVM • Peer-to-Peer Evidence Sync • Homomorphic Query</p>
                </div>
