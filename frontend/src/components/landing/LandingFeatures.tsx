        ...
        <section id="features" className="py-24 px-4">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 rounded-full border border-[#22C55E]/30 bg-[#22C55E]/5 px-4 py-2 mb-4 shadow-[0_0_15px_rgba(34,197,94,0.1)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {FEATURES.map((feature) => {
                        ...
                        return (
                            <div
                                key={feature.title}
                                className="group flex flex-col justify-between h-full rounded-2xl border border-tactical-border bg-tactical-surface p-7 hover:border-tactical-border/80 transition-all duration-300 hover:-translate-y-1 shadow-lg"
                                onMouseEnter={(e) => {
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    {/* Icon */}
                                    <div
                                        className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl border transition-transform duration-300 group-hover:scale-110"
                                        style={{
                                    ...
                                    {/* Title */}
                                    <h3 className="font-bold text-tactical-text text-lg mb-3 leading-snug">
                                        {feature.title}
                                    </h3>

                                    {/* Description */}
                                    <p className="text-tactical-text-muted text-sm leading-relaxed mb-6">
                                        {feature.description}
                                    </p>
                                </div>

                                {/* Bottom Tag Chips Area with Fixed Minimum Height so the Divider Line is Perfectly Aligned Across All Cards */}
                                <div className="mt-auto pt-5 border-t border-tactical-border/50 min-h-[76px] flex flex-wrap content-start gap-2">
                                    {feature.tags.map((tag) => (
                                        <span
                                            key={tag}
                                            className="rounded-lg border px-2.5 py-1 font-mono text-[9px] font-bold tracking-widest uppercase transition-all"
                                            style={{
                                                borderColor: `${feature.color}35`,
                                                color: feature.color,
