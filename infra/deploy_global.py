#!/usr/bin/env python3
"""
FORENZA — Global Multi-Node Deployment Script (Cross-Platform)
...
"""
    ...
    content = f"""# ═══════════════════════════════════════════════════════════════════════════════
# FORENZA — Global Network Docker Compose
...
services:
  ...
  orchestrator:
    build:
      context: ../backend
      dockerfile: Dockerfile
    container_name: forenza-orchestrator
    ports:
      - "8000:8000"
    environment:
...
def cmd_up():
    print("\n" + "═"*60)
    print("  FORENZA — Global Network Deployment")
    print("═"*60 + "\n")
