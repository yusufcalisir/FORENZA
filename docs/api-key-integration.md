...
| **Backend** | Python FastAPI Engine | `FASTAPI_BACKEND_URL` | `backendUrl` | 38 biocomputational microservice endpoints (MCMC, BPA, Horvath Clock, Geo-Forensics, Lineage Y-STR/mtDNA) |
