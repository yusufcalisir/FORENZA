        ...
        >
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar border-b border-tactical-border/60">
                    <button
                        onClick={() => {
                            if (!["statistical", "probabilistic", "relationship", "bayesian", "lineage", "dvi", "hid", "validation", "genomics", "qc"].includes(activeTab)) {
                        ...
                        className={`px-3.5 py-2 rounded-t-lg font-mono text-xs font-bold transition-all border-b-2 flex items-center gap-2 ${
                            ["statistical", "probabilistic", "relationship", "bayesian", "lineage", "dvi", "hid", "validation", "genomics", "qc"].includes(activeTab)
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar sm:overflow-visible sm:pb-0">
                    {["statistical", "probabilistic", "relationship", "bayesian", "lineage", "dvi", "hid", "validation", "genomics", "qc"].includes(activeTab) && (
                        <>
                            ...
                            <TabButton id="qc" label="QA/QC Gatekeeper" icon={ShieldCheck} activeTab={activeTab} onClick={setActiveTab} badge="ISO-17025" />
                        </>
                    )}
