...
export default function MicrobiologyPanel() {
  ...
  // Mock 16S rRNA Taxa Distribution
  const taxaData = [
    ...
    { genus: "Other Unclassified", phylum: "Environmental", percentage: 5, color: "bg-zinc-600" },
  ];
    ...
    <div className="space-y-6 font-mono">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-tactical-border/60 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm sm:text-base font-bold tracking-widest text-tactical-text uppercase">
              Forensic Microbiology & 16S rRNA Hub
            </h2>
        ...
        <div className="flex items-center gap-1.5 p-1 rounded-xl bg-black/40 border border-tactical-border/60">
          ...
          >
            16S rRNA Taxonomic Distribution
          </button>
          <button
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-xl border border-tactical-border/60 bg-tactical-surface/40 p-4 space-y-1">
              <span className="text-[10px] text-zinc-500 font-bold uppercase">Microbial Sample ID</span>
              <p className="text-base font-bold text-purple-400 font-mono">MIC-SAMPLE-301</p>
              <p className="text-[9px] text-zinc-400">Biological trace touch swab</p>
            </div>
            <div className="rounded-xl border border-tactical-border/60 bg-tactical-surface/40 p-4 space-y-1">
              <span className="text-[10px] text-zinc-500 font-bold uppercase">Dominant Taxon</span>
              <p className="text-base font-bold text-tactical-text font-mono">Cutibacterium (65%)</p>
              <p className="text-[9px] text-zinc-400">Actinomycetota phylum</p>
            </div>
            <div className="rounded-xl border border-tactical-border/60 bg-tactical-surface/40 p-4 space-y-1">
              <span className="text-[10px] text-zinc-500 font-bold uppercase">Shannon Diversity Index</span>
              <p className="text-base font-bold text-emerald-400 font-mono">H' = 0.9421</p>
              <p className="text-[9px] text-zinc-400">Low-diversity skin community signature</p>
            </div>
          </div>
      ...
      {activeSubTab === "origin" && (
        <div className="space-y-6">
          <div className="rounded-2xl border border-tactical-border/80 bg-tactical-surface/50 p-5 space-y-4 shadow-lg">
            <div className="flex items-center justify-between border-b border-tactical-border/40 pb-3">
              <span className="text-xs font-bold text-tactical-text uppercase tracking-wider">
                Microbial Body Site & Environmental Origin Prediction
              </span>
              <span className="text-[9px] text-purple-400 font-bold bg-purple-500/10 border border-purple-500/20 px-2 py-0.5 rounded">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="rounded-xl border border-tactical-border/50 bg-black/20 p-4 space-y-2">
                <span className="text-zinc-500 block">Predicted Body Site</span>
                <p className="text-base font-bold text-purple-400 font-mono">SEBACEOUS_SKIN</p>
                <p className="text-[10px] text-zinc-400">Confidence Score: 94.0%</p>
              </div>

              <div className="rounded-xl border border-tactical-border/50 bg-black/20 p-4 space-y-2">
                <span className="text-zinc-500 block">Key Indicator Taxa</span>
              ...
              <div className="rounded-xl border border-tactical-border/50 bg-black/20 p-4 space-y-2">
                <span className="text-zinc-500 block">Bray-Curtis Soil Distance</span>
                <p className="text-sm font-bold text-emerald-400 font-mono">D_Bray-Curtis = 0.9850</p>
                <p className="text-[10px] text-zinc-400">High dissimilarity to environmental soil</p>
              </div>
            </div>
          </div>
        </div>
