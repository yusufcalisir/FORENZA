        ...
        <div className="space-y-4">
          {result && (
            ...
            >
              ...
              <div className="h-44 relative flex items-center justify-center border border-dashed border-tactical-border/40 rounded-xl p-4 bg-black/40 overflow-hidden">
