...
export const saasTranslations: Record<SaasLanguage, SaasTranslation> = {
  en: {
    ...
    security: {
      ...
      passedBadge: "808 TESTS VERIFIED",
      pillars: [
        {
      ...
      specs: [
        ...
        { label: "Automated Test Suite", value: "808 / 808 Automated Tests Passed (100% Invariant Validation)" },
  ...
  tr: {
    ...
    subsystems: {
      ...
      pytestInvariantsValue: "808 / 808 Doğrulandı",
    ...
    security: {
      ...
      passedBadge: "%100 DOĞRULANMIŞ (808 TEST)",
      pillars: [
        {
      ...
      specs: [
        ...
        { label: "Doğrulanmış Test Paketi", value: "808 / 808 Otomatik Test Başarılı (%100 İnvaryant Doğrulaması)" },
