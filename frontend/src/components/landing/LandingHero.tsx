...
const METRICS = [
    { value: 30, suffix: "", label: "Forensic Subsystems", color: "#22C55E" },
    { value: 215, suffix: " / 215", label: "Verified Invariants", color: "#06B6D4" },
    { value: 100, suffix: "%", label: "ISO 17025 Compliance", color: "#8B5CF6" },
    { value: 12, prefix: "< ", suffix: "ms", label: "ZK Proof Latency", color: "#22C55E" },
];
            ...
            <div className="my-auto relative z-10 mx-auto max-w-5xl text-center flex flex-col items-center">
                ...
                <div className="inline-flex items-center gap-2 rounded-full border border-[#06B6D4]/30 bg-[#06B6D4]/5 px-3.5 sm:px-4 py-1.5 mb-3 sm:mb-6 shadow-[0_0_20px_rgba(6,182,212,0.1)]">
                    ...
                    <span className="font-mono text-[9px] sm:text-[10px] tracking-widest text-[#06B6D4] font-medium uppercase">
                        ADVANCED MULTI-OMIC FORENSIC EVIDENCE OS
                    </span>
                </div>
                ...
                <p className="max-w-xl sm:max-w-2xl mx-auto text-xs sm:text-base text-tactical-text-muted mb-4 sm:mb-8 leading-relaxed font-light">
                    FORENZA combines likelihood ratio STR analysis, MCMC mixture deconvolution, HIrisPlex-S phenotyping, Horvath epigenetics, serology, pathology, LIMS accessioning, QA/QC gatekeeping, analyst governance, and court reporting into a single tactical evidence operating system.
                </p>
